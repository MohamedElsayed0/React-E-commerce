...
const Jewelry = ({history,productByID,getOneProduct,addProduct,updateProduct}) => {
...
export default connect(mapStateToProps,{getOneProduct,addProduct,updateProduct}) (Jewelry);
