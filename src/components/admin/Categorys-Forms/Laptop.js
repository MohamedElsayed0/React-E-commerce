...
const Laptop = ({ productByID,getOneProduct,addProduct,updateProduct,history}) => {
  ...
  useEffect(()=>{getOneProduct(query)},[getOneProduct,query])
    ...
    <div className="Laptop">
      <div className="container">
        <div className="row ">
          ...
          <div className="col-md-4 col-sm-6 col-9 mt-5">
...
export default connect(mapStateToProps,{ getOneProduct,addProduct,updateProduct}) (Laptop);
